...
parser.add_argument('--rec_fr', type=float, default=1e-4,
                    help='The weight of reconstruction loss')
...
parser.add_argument('--lr_rate', type=float, default=1e-5,
                    help='Learning rate')
parser.add_argument('--lr_rate_dis', type=float, default=1e-5,
                    help='Learning rate of discriminator')
parser.add_argument('--lr_rate_lte', type=float, default=1e-6,
...
parser.add_argument('--train_crop_size', type=int, default=64,
...
parser.add_argument('--hr_path', type=str, default='/home/ying/IXI/BaiduNetdiskDownload/train/T2_test',
                    help='The path of hr image when testing')
parser.add_argument('--lr_path', type=str, default='/home/ying/IXI/BaiduNetdiskDownload/train/T2_testlr',
                    help='The path of ref image when testing')
