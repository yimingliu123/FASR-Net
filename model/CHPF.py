...
class CHPF(nn.Module):
    ...
    def forward(self, x, S1, S2, S3, T_lv3, T_lv2, T_lv1):
        ...
        x22_res = x22_res * F.interpolate(S2, scale_factor=2, mode='bicubic')
        x22 = x22 + x22_res
        ...
        x33_res = x33_res * F.interpolate(S1, scale_factor=4, mode='bicubic')
        x33 = x33 + x33_res
